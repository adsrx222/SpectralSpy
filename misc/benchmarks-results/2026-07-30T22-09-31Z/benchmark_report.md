...
| Stage | Mean | P95 | P99 |
|---|---|---|---|
| End-To-End Latency (ms) | 3.06 | 4.00 | 5.00 |
| Hash Entropy (bits) | 9.59 | 0.00 | 0.00 |
| Hash Collisions | 15.00 | 0.00 | 0.00 |
| API Latency (1 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (10 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (100 users) ms | 0.05 | 0.05 | 1.00 |
| API Latency (500 users) ms | 0.27 | 1.00 | 2.00 |
