...
| Stage | Mean | P95 | P99 |
|---|---|---|---|
| End-To-End Latency (ms) | 2988.09 | 18923.40 | 19295.15 |
| Hash Entropy (bits) | 0.00 | 0.00 | 0.00 |
| Hash Collisions | 0.00 | 0.00 | 0.00 |
| API Latency (1 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (10 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (100 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (500 users) ms | 0.66 | 2.00 | 2.00 |
