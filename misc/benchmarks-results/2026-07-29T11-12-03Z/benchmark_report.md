...
| Stage | Mean | P95 | P99 |
|---|---|---|---|
| End-To-End Latency (ms) | 3.36 | 4.00 | 5.00 |
| Hash Entropy (bits) | 9.79 | 0.00 | 0.00 |
| Hash Collisions | 13.00 | 0.00 | 0.00 |
| API Latency (1 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (10 users) ms | 0.10 | 0.55 | 0.91 |
| API Latency (100 users) ms | 0.28 | 1.00 | 2.00 |
| API Latency (500 users) ms | 5.66 | 20.00 | 26.01 |
