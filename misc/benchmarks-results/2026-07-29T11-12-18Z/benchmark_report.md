...
| Stage | Mean | P95 | P99 |
|---|---|---|---|
| End-To-End Latency (ms) | 3.48 | 4.00 | 5.00 |
| Hash Entropy (bits) | 9.16 | 0.00 | 0.00 |
| Hash Collisions | 10.00 | 0.00 | 0.00 |
| API Latency (1 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (10 users) ms | 0.50 | 1.00 | 1.00 |
| API Latency (100 users) ms | 0.72 | 3.00 | 4.02 |
| API Latency (500 users) ms | 3.23 | 16.00 | 26.00 |
