...
| Stage | Mean | P95 | P99 |
|---|---|---|---|
| End-To-End Latency (ms) | 3.28 | 4.00 | 5.00 |
| Hash Entropy (bits) | 9.37 | 0.00 | 0.00 |
| Hash Collisions | 60.00 | 0.00 | 0.00 |
| API Latency (1 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (10 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (100 users) ms | 0.36 | 1.00 | 3.02 |
| API Latency (500 users) ms | 8.37 | 25.05 | 34.01 |
