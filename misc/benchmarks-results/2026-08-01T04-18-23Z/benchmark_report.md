...
| Stage | Mean | P95 | P99 |
|---|---|---|---|
| End-To-End Latency (ms) | 1.97 | 2.29 | 3.02 |
| Spectrogram Duration (ms) | 1.41 | 1.74 | 1.96 |
| Peak-Finding Duration (ms) | 0.40 | 0.51 | 0.55 |
| Hash Generation Duration (ms) | 0.03 | 0.04 | 0.05 |
| Hash Entropy (bits) | 7.61 | 0.00 | 0.00 |
| Hash Collisions | 7.00 | 0.00 | 0.00 |
| API Latency (1 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (10 users) ms | 0.00 | 0.00 | 0.00 |
| API Latency (100 users) ms | 0.04 | 0.00 | 1.00 |
| API Latency (500 users) ms | 0.04 | 0.00 | 1.00 |
